...
public class MatchAbleString {
	...
	private List<Integer> matchSubstr(Pattern p, int parts, int i) {
		/*
		 * Tehát a szöveget parts darabra bontjuk. Mindegyik kezdõpontja az i *
		 * length / parts, ezek az osztópontok. Azért hogy meglegyen a megfelelõ
		 * átfedés, a hossz a length / parts-nál p.getLength() - 1 -gyel
		 * hosszabb, kivéve az utolsó string esetén, ahol viszont a
		 * kerekítésekbõl származó különbséget vesszük hozzá.
		 */
